...
##### Create annotation data #####
  Anno.df <- data.frame(TestID = c("Predict1","Predict2","Predict3","Predict4","Predict5",
                                   ...
                                   "Predict21","Predict22","Predict23","Predict24","Predict25",
                                   "Predict26","Predict27","Predict28","Predict29","Predict30"),
                        Tool = c("ToolA","ToolA","ToolA","ToolB","ToolB","ToolB","ToolC","ToolC","ToolC",
                                 "ToolD","ToolD","ToolD","ToolE","ToolE","ToolE","ToolA","ToolA","ToolA",
                                 "ToolB","ToolB","ToolB","ToolC","ToolC","ToolC",
...
##### Create simulation datafrme #####
  ...
  Simu_Bi.df <- data.frame(Actual = Actual1_1,
                           ...
                           Predict16 = Actual1_1,
                           Predict17 = sample(c(0,1), 100, replace = TRUE),
                           Predict18 = sample(c(0,1), 100, replace = TRUE),
                           Predict19 = c(Actual1_1[1:80],sample(c(0,1), 20, replace = TRUE)),
                           Predict20 = sample(c(0,1), 100, replace = TRUE),
                           Predict21 = sample(c(0,1), 100, replace = TRUE),
                           Predict22 = c(Actual1_1[1:60],sample(c(0,1), 40, replace = TRUE)),
                           Predict23 = sample(c(0,1), 100, replace = TRUE),
                           Predict24 = sample(c(0,1), 100, replace = TRUE),
                           Predict25 = c(Actual1_1[1:40],sample(c(0,1), 60, replace = TRUE)),
                           Predict26 = sample(c(0,1), 100, replace = TRUE),
                           Predict27 = sample(c(0,1), 100, replace = TRUE),
                           Predict28 = c(Actual1_1[1:20],sample(c(0,1), 80, replace = TRUE)),
                           Predict29 = sample(c(0,1), 100, replace = TRUE),
                           Predict30 = sample(c(0,1), 100, replace = TRUE))
  Word.set <- c("A","B")
