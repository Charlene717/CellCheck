...
##### Create annotation data #####
  Simu_Anno.df <- data.frame(TestID = c("Predict1","Predict2","Predict3","Predict4","Predict5",
                             ...
                             Tool = c("ToolA","ToolB","ToolC","ToolA","ToolB","ToolC",
                                      "ToolA","ToolB","ToolC","ToolA","ToolB","ToolC",
                                      "ToolA","ToolB","ToolC"),
                             Type = c("LUAD","LUAD","LUAD","PAAD","PAAD","PAAD",
                                      "HNSC","HNSC","HNSC","GBM","GBM","GBM",
                                      "BRCA","BRCA","BRCA"),
                             PARM = seq(1:15))
...
##### Create simulation datafrme #####
  ...
  Word.set <- c("Malignant","Nonmalignant")
  ...
  Word.set <- c("Fib1","Fib2","BCell","NKCell","Cancer1","Cancer2","CD4","CD8","Epith","MP")
...
##### Save the RData #####
  ...
  save.image("Create_simulation_datafrme3.RData")
